...
@notificacion_usuario_controller.post("/", response_model=NotificacionUsuarioResponse)
...
@notificacion_usuario_controller.patch("/{notificacion_id}/usuario/{usuario_id}/leido", response_model=NotificacionUsuarioResponse)
...
@notificacion_usuario_controller.get("/usuario/{usuario_id}/mis-notificaciones", response_model=list[NotificacionUsuarioResponse])
