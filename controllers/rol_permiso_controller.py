...
@rol_permiso_controller.post("/", response_model=RolPermisoResponse, dependencies=[Depends(require_permissions(["editar_roles"]))])
...
@rol_permiso_controller.patch("/{rol_id}/permiso/{permiso_id}/vigencia", response_model=RolPermisoResponse, dependencies=[Depends(require_permissions(["editar_roles"]))])
...
@rol_permiso_controller.get("/rol/{rol_id}", response_model=list[RolPermisoResponse], dependencies=[Depends(require_permissions(["ver_roles"]))])
